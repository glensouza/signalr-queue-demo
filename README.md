...
4. **Check in someone else (multi-tracking):** tap **Check someone else in**. The form reappears *without* discarding the first person — check in a second visitor and the device now shows **both** cards, each with its own live position. This is deliberate: checking someone else in never costs you sight of your own spot. Tap **Stop tracking** on a card to drop just that person.
